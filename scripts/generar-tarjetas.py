...
TARJETAS = [
    dict(out="li-primero-autonomo.jpg", fmt=H_LI, tema=PAPEL, kicker="Por dónde empezar",
         titulo="Autónomo o equipo: no se empieza por lo mismo",
         items=[], cta="Cuál es tu caso →"),
    dict(out="ig-proceso-5-lineas.jpg", fmt=H_IG, tema=NOCHE, kicker="Plantilla · guárdatela",
         titulo="Tu proceso en 5 líneas",
         items=["Qué lo dispara",
                "De dónde sale la información",
                "Qué haces con ella",
                "A dónde va al final",
                "Cuándo decides tú"],
         cta="Más ideas, en la bio →"),
    dict(out="li-cuando-falla.jpg", fmt=H_LI, tema=NOCHE, kicker="Cuando la IA falla",
         titulo="Una IA que dice «no lo sé» da menos miedo",
         items=[], cta="Las 3 reglas que pongo →"),
    dict(out="li-coruna.jpg", fmt=H_LI, tema=PAPEL, kicker="A Coruña",
         titulo="Aquí nadie me pide un robot",
         items=[], cta="Lo que sí me piden →"),
]
