...
TARJETAS = [
    dict(out="li-parche.jpg", fmt=H_LI, tema=PAPEL, kicker="Parche o sistema",
         titulo="Si se rompe y nadie se entera, era un parche",
         items=[], cta="Las 3 señales →"),
    dict(out="li-quien-lo-hace.jpg", fmt=H_LI, tema=NOCHE, kicker="Antes de construir",
         titulo="Pregunta a quien lo hace, no a quien lo manda",
         items=[], cta="Los 20 minutos que lo cambian →"),
    dict(out="ig-despacho-tienda.jpg", fmt=H_IG, tema=NOCHE, kicker="Despacho / tienda",
         titulo="Misma IA. Trabajo distinto",
         items=["DESPACHO: entra por escrito",
                "Ahí la IA ordena y cuadra",
                "TIENDA: entra hablando",
                "Ahí la IA responde y agenda"],
         cta="Cuál es tu caso, en la bio →"),
    dict(out="li-antes-de-mejorar.jpg", fmt=H_LI, tema=NOCHE, kicker="De la pista",
         titulo="Antes de mejorar, se empeora",
         items=[], cta="Por que casi nadie lo avisa →"),
]
